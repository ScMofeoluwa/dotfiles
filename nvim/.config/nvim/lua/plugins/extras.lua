return {
  ...
  },
  {
    ...
    config = function()
      ...
      which_key.add({
        { "gi", require("telescope.builtin").lsp_implementations, desc = "Goto [I]mplementation" },
        { "gt", require("telescope.builtin").lsp_type_definitions, desc = "Goto [T]ype Definition" },
        { "<leader>b", group = "Buffer" },
        { "<leader>c", group = "Code" },
        { "<leader>ca", vim.lsp.buf.code_action, desc = "Code Action" },
        { "<leader>cA", vim.lsp.buf.code_action, desc = "Range Code Actions", mode = "v" },
        ...
        { "<leader>cl", "<cmd>Trouble diagnostics filter.buf=0<cr>", desc = "Document Diagnostics (Trouble)" },
        { "<leader>cL", "<cmd>Trouble diagnostics<cr>", desc = "Workspace Diagnostics (Trouble)" },
...

  {
    ...
    keys = {
      { "<leader>do", "<cmd>DiffviewOpen<cr>", desc = "Diffview Open (Current Changes)" },
      { "<leader>dc", "<cmd>DiffviewClose<cr>", desc = "Diffview Close" },
      { "<leader>dh", "<cmd>DiffviewFileHistory %<cr>", desc = "Diffview File History (Current File)" },
      { "<leader>dH", "<cmd>DiffviewFileHistory<cr>", desc = "Diffview File History (Repo)" },
      -- Note: <leader>b and <leader>e are defaults for toggle/focus panel
    },
    config = function()
